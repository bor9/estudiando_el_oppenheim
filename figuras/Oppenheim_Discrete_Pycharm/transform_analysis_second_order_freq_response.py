...
leg = plt.legend([r'$\theta=\dfrac{\pi}{4}$', r'$\theta=\dfrac{\pi}{2}$', r'$\theta=\dfrac{3\pi}{4}$'],
                 loc=0, bbox_to_anchor=[0.5, 0.2], frameon=False, fontsize=fs, framealpha=1)

# save as pdf image
plt.savefig('transform_analysis_second_order_freq_response_theta.pdf', bbox_inches='tight')
