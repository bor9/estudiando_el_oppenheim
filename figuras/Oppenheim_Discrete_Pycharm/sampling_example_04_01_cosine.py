...
nper = int(np.floor(fmax / omega_s))
...
nper = int(np.floor(fmax / omega_s))
for i in np.arange(-nper, nper + 1):
    plt.annotate(s='', xytext=(i * omega_s + omega_0, 0), xy=(i * omega_s + omega_0, a_height),
                 arrowprops=dict(arrowstyle='->, head_width=0.2, head_length=0.6', color='black',
                                 shrinkA=0, shrinkB=0))
    plt.annotate(s='', xytext=(i * omega_s - omega_0, 0), xy=(i * omega_s - omega_0, a_height),
                 arrowprops=dict(arrowstyle='->, head_width=0.2, head_length=0.6', color='r',
...
plt.savefig('sampling_example_04_01_cosine.pdf', bbox_inches='tight')
