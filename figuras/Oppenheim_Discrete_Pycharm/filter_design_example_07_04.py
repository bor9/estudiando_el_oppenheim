...
plt.legend(bbox_to_anchor=(0.05, 0.2), loc='lower left', frameon=False, fontsize=fontsize, framealpha=1)
plt.axis('off')
plt.savefig('filter_design_example_07_04_specifications.pdf', bbox_inches='tight')
...
plt.savefig('filter_design_example_07_04_pole_zero.pdf', bbox_inches='tight')
...
fig = plt.figure(2, figsize=(10, 9), frameon=False)
# Butterworth
...
plt.savefig('filter_design_example_07_04_Hz_magnitude.pdf', bbox_inches='tight')
plt.show()
